    ...
    <section id="hero" className="pt-28 pb-16 md:pt-40 md:pb-24 overflow-hidden bg-[#E6E7EE] dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          >
            ...
            <motion.div
              ...
              variants={itemVariants}
            >
              <FaGraduationCap className="text-indigo-600 dark:text-indigo-400" size={20} />
            ...
            <motion.div
              ...
              variants={itemVariants}
            >
              <FaLanguage className="text-indigo-600 dark:text-indigo-400" size={20} />
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -z-10 w-64 h-64 md:w-80 md:h-80 rounded-full bg-gradient-to-r from-indigo-300 to-purple-300 blur-3xl opacity-30 top-10 -left-10" />
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          >
            <FaArrowDown size={16} className="text-indigo-600 dark:text-indigo-400" />
          </button>
        </motion.div>
      </div>
    </section>
